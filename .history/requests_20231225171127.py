...
url = "https://www.myntra.com/gateway/v2/search/dresses?f=Gender%3Amen%20women%2Cwomen&p=2&rf=Discount%20Range%3A10.0_100.0_10.0%20TO%20100.0&rows=50&o=49&plaEnabled=false&xdEnabled=false&pincode=752115"
...
response = requests.requests("GET", url, headers=headers, data=payload)
