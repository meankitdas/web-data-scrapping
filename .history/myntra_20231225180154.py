...
for product in data['products']:
    ...
    product_imageURL = product['searchImage']
    product_price = product['price']
    product_primaryColor = product['primaryColour']
    product_data = {
    'name': product_name,
    'image': product_imageURL,
    'price': product_price,
    'color': product_primaryColor
}
    
    products.append(name= product_name, image= product_imageURL, price=product_price, color=product_primaryColor )
